                     ...
                     if($result->num_rows > 0){
                      ...
                      while($row = $result->fetch_array()){
                        ...
                        //echo "id =".$row['id']." Name=".$row['uname']."<br>";
                                   ...
                                   ?>
                  <img class="wd-30 ht-30 rounded-circle" src="https://static.vecteezy.com/system/resources/previews/008/442/086/non_2x/illustration-of-human-icon-user-symbol-icon-modern-design-on-blank-background-free-vector.jpg" alt="profile">
                  <?php
                     }
                  ...
                  <div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
                     <div class="mb-3">
                        ...
                        <?php
                           ...
                           ?>
                        <!--<img class="wd-80 ht-80 rounded-circle" src="https://static.vecteezy.com/system/resources/previews/008/442/086/non_2x/illustration-of-human-icon-user-symbol-icon-modern-design-on-blank-background-free-vector.jpg" alt="">-->
                     </div>
