            ...
            <div class="col-md-12 grid-margin stretch-card">
               <div class="card">
                  <div class="card-body">
                     ...
                     <form action="adds-client.php" method="post" enctype="multipart/form-data" class="row">
                        ...
                        <div class="col-md-6 mb-3">
                           <label for="exampleInputMobile" class="col-sm-3 col-form-label">Address</label>
                            <textarea class="form-control" name="address" id="exampleInputMobile" placeholder="Enter Your Address" row="3"></textarea>
                        </div>
                        <!-- <div class="col-md-6 mb-3">
...
<?php
   ...
   $sql = "INSERT INTO clients(name,gender,dob,email,mobile,password, address, status)
   VALUES ('$name','$gender','$dob','$email','$mobile','$passw', '$address', 0)";
   ...
   if (mysqli_query($conn, $sql)) {
      ...
      <div class="popup popup--icon -success js_success-popup popup--visible">
         ...
         <div class="popup__content">
            ...
            <p>
               <a href="client_data.php"><button class="button button--success" data-for="js_success-popup">OK</button></a>
         </p>
         </div>
      </div>
<?php
