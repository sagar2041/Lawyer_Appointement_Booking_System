<nav class="sidebar">
 ...
 Visit website - www.mayurik.com -->
            ...
            <a class="nav-link" data-bs-toggle="collapse" href="#emails6" role="button" aria-expanded="false" aria-controls="emails">
            <i class="link-icon" data-feather="box"></i>
            <span class="link-title">Appointments</span>
            <i class="link-arrow" data-feather="chevron-down"></i>
            </a>
            <div class="collapse" id="emails6">
               <ul class="nav sub-menu">
                  <li class="nav-item">
                     <a href="appointments_calendar.php" class="nav-link">Appointments calendar</a>
                  </li>
                  <li class="nav-item">
                     <a href="view_appointments.php" class="nav-link">View Appointments</a>
                  </li>
               </ul>
            </div>
         </li>
         ...
         <li class="nav-item">
          ...
          <!-- <li class="nav-item">
            <a href="https://mayurik.com/source-code/P6603/advocate-management-system-project-in-php" target="_blank" class="nav-link">
            <i class="link-icon" data-feather="box"></i>
            <span class="link-title">Kortex Pro Update</span>
            </a>
         </li> -->
<!-- 
<li class="nav-item">
            <a href="https://www.mayurik.com/#download_section" target="_blank" class="nav-link">
...
<!-- <li class="nav-item">
            <a href="https://www.youtube.com/@MayuriK/videos" target="_blank" class="nav-link">
            <i class="link-icon" data-feather="film"></i>
            <span class="link-title">All Demo</span>
            </a>
         </li> -->
