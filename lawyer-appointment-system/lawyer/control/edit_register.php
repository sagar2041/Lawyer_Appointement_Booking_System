				...
				<div class="card-body">
                    ...
                    <form method="post" enctype="multipart/form-data">
                        <input type="hidden" name="case_register_id" value="<?php echo $user_row['case_register_id'];?>">
                           ...
                           <label>Case No</label>
                            <input type="text" name="case_no" class="form-control" value="<?php echo $user_row['case_no'];?>">
							<br><br>
							...
							<div class="mb-3">
										...
										<textarea class="form-control" name="description" id="exampleFormControlTextarea1" value= "<?php echo $user_row['description'];?>" rows="5" cols="200"><?php echo $user_row['description'];?></textarea>
									</div>
							...
							<!-- <div class="mb-3">
								...
								<br>
								<br>
							<input class="btn btn-secondary" type="submit"  name="update2" value="Update">
                    </form>
                </div>
				</div>
				</div>
