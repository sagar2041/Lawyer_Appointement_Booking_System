...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($password != $confirm_password) {
        ...
        $sql_check = "SELECT * FROM lawyers WHERE name='$name' OR email='$email' LIMIT 1";
        ...
        if ($result_check->num_rows > 0) {
            ...
            <div class="popup__content">
               ...
               <p>
                  <a href="lawyer_signup.php"><button class="button button--error" data-for="js_error-popup">Close</button></a>
               </p>
            </div>
         </div>';
        } else {
            $sql_query = "INSERT INTO lawyers (name, gender, email, password, mobile, lawyer_type) VALUES ('$name','$gender','$email','$pass','$mobile','$lawyer_type')";
...
<body>
  ...
  <path fill-rule="evenodd" d="M14.5 1.5a.5.5 0 0 1 .5.5v4.8a2.5 2.5 0 0 1-2.5 2.5H2.707l3.347 3.346a.5.5 0 0 1-.708.708l-4.2-4.2a.5.5 0 0 1 0-.708l4-4a.5.5 0 1 1 .708.708L2.707 8.3H12.5A1.5 1.5 0 0 0 14 6.8V2a.5.5 0 0 1 .5-.5"/>
                        ...
                        <div class="col-md-8 mx-auto">
                            ...
                            <div>
         <h4 class="mb-3 mb-md-0" style="text-align : center; margin: -80px">Lawyer Sign Up </h4>
      </div>
                                <form class="forms-sample signup-form" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="lawyer_type" id="lawyer_type" placeholder="Lawyer Type" required>
                                    </div>
                                    <div class="mb-3">
